...
operators.forEach((operator) => {
  // looping through the operators button
  operator.addEventListener("click", () => {
    // addEventListener to all the operator buttons
...
check.addEventListener("click", () => {
  ...
  document.getElementById("calculateArea").style.background =
    "hsl(223, 31%, 20%)";
...
checker.addEventListener("click", () => {
  ...
  document.getElementById("deleteBtn").style.boxShadow =
  ...
  document.getElementById("resetBtn").style.boxShadow =
    "rgba(0, 0, 0, 0.24) 0px 3px 8px";
});
...
checks.addEventListener("click", () => {
  ...
  document.querySelector("#deleteBtn").style.boxShadow =
    " rgba(188, 21, 244) 0px 3px 8px)";
  document.getElementById("deleteBtn").style.boxShadow =
    " rgba(188, 21, 244) 0px 3px 8px";
  document.getElementById("resetBtn").style.boxShadow =
    " rgba(188, 21, 244) 0px 3px 8px";
  document.getElementById("resetBtn").style.background = "  hsl(281, 89%, 26%)";
  document.getElementById("equalBtn").style.background =
    "  hsl(176, 100%, 44%)";
